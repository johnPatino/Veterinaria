...
public class Ventana extends javax.swing.JFrame {
    ...
    private void BuscarProActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BuscarProActionPerformed
      if(erroNoexiste(Integer.parseInt(idproductos.getText()))){
           GestionProductos gp =new GestionProductos();
      ...
      Stocktxt.setText(String.valueOf(pro.getStock()));
          ...
          JOptionPane.showMessageDialog(null,"Producto no existenete");
    ...
    public Boolean erroNoexiste(int idpro){
        boolean trues=false;
        GestionProductos gp= new GestionProductos();
        ArrayList<Producto>npro = gp.getListProducto();
        for (int i=0;i<npro.size();i++) {
           if(npro.get(i).getPro_id()==idpro){
               trues = true;
            break;
           }
        }
